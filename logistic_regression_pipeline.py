...
def logistic_regression_pipeline(X, y, names_TMs, cnt_var, names_classes, solver):
    import pandas as pd
    ...
    coefficients = pd.DataFrame(data = parameters, columns = ['TM_intercept']+names)
    ...
    return(performances_per_threshold_val, performance_val, predicted_prob, predicted_class, 
           ...
           val_indices, probabilities, coefficients, prob_thresholds, logregs, scalers)
